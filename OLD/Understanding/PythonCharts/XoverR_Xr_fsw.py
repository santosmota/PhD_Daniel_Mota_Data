...
save_path = simulation_path + picture_folder + 'XoverR_Xr_fsw.eps'
...
axs[1].set_xlabel(r'Switching frequency (Hz)')
axs[1].set_xticks(np.arange(start_freq, end_freq+500, 500))
