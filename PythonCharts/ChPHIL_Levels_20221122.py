...
def superficies():
    ...
    axes.annotate3D(r'81\,V, 72\,A, 5.4\,\%', (72, 81, 5.37),
                  xytext=(30, 10),
                  textcoords='offset points',
                  bbox=dict(boxstyle="round", fc="lightyellow"),
                  arrowprops=dict(arrowstyle="->", color='black', lw=1.5))

    axes.annotate3D('74\,V, 72\,A, 5.0\,\%', (72, 74, 5.0),
                    xytext=(-50, -20),
                    textcoords='offset points',
                    bbox=dict(boxstyle="round", fc="lightyellow"),
    ...
    axes.annotate3D('363\,V, 72\,A, 78.8\,\%', (72, 363, 80),
                    xytext=(-10, -30),
                    textcoords='offset points',
                    bbox=dict(boxstyle="round", fc="lightyellow"),
                    arrowprops=dict(arrowstyle="->", color='black', lw=1.5))
    ...
    fig.tight_layout()
    fig.savefig('PHIL3dplot.pdf', format='pdf')
