...
def plot_charts_time_fft(csv_rollingsamples=0,
    ...
    if power_level == 0.8:
        ...
        mat_full_path = '../Modelos/ChPHIL/SimulationResults/P_08_Q_0375Mvar_5usstep.mat'
        ...
        csv_full_path_00 = '../Modelos/ChPHIL/ExperimentalResults/20221104/C1.CSV'
        csv_full_path_01 = '../Modelos/ChPHIL/ExperimentalResults/20221104/C3.CSV'

        figure_name = 'PHILvsMATPow080' + figure_type
        figure_fft_name = 'PHILvsMATPow080FFT' + figure_type
    ...
    csv_color_00 = pe.cor_dalt['green']
    csv_color_01 = pe.cor_dalt['red']
    ...
    ax_00_ins = axes[0].inset_axes([0.19, 0.075, 0.28, 0.5])
    ...
    axes[0].indicate_inset_zoom(ax_00_ins, edgecolor="black")

    #######################
    # Currents
    axes[1].plot(csv_df_00['time'],
                    csv_df_00['Ia']/1e3,
                    color=csv_color_00,
                    linewidth=csv_lin_width,
                    linestyle=csv_00_lin_style,
    ...
    ax_10_ins = axes[1].inset_axes([0.19, 0.05, 0.28, 0.5])
    ...
    axes[1].indicate_inset_zoom(ax_10_ins, edgecolor="black")

    #######################
    # Active power
    axes[2].plot(csv_df_00['time'],
                    csv_df_00['P']/1e6,
                    color=csv_color_00,
                    linewidth=csv_lin_width,
                    linestyle=csv_00_lin_style,
    ...
    # axis limits
    ##########################################################################
    axes[2].set_xticks(np.arange(40, 80, 2))
    axes[2].set_xlim([40, 60])
    # axes[1, 0].set_xlim([0, 60])

    axes[0].set_yticks(np.arange(-600.0, 800.0, 200.0))
    axes[0].set_ylim([-650, 650])
    # axes[0][0].yaxis.set_major_formatter(FormatStrFormatter('%.3f'))

    axes[1].set_yticks(np.arange(-6.0, 8.0, 2.0))
    axes[1].set_ylim([-6.0, 6.0])

    axes[2].set_yticks(np.arange(3.5, 4.5, 0.1))
    axes[2].set_ylim([3.8, 4.2])
    # axes[0, 1].set_ylim([2, 6])

    axes[3].set_yticks(np.arange(-1.0, 1.0, 0.25))
    axes[3].set_ylim([-0.75, 0.25])
    ...
    # axis names
    ##########################################################################
    axes[3].set_xlabel(r'Time (ms)')

    axes[0].set_ylabel(r'Voltage (V)')
    axes[1].set_ylabel(r'Current (kA)')
    axes[2].set_ylabel(r'Active Power (MW)')
    axes[3].set_ylabel(r'Reactive (Mvar)')

    axes_fft[1].set_xlabel(r'Time (ms)')
    # axes_fft[1][1].set_xlabel(r'Time (ms)')

    axes_fft[0].set_ylabel(r'Voltage (V)')
    ...
    #
    axes[0].annotate(r'a', xy=(0.05, 0.85), xycoords='axes fraction',
                        bbox=dict(boxstyle='circle', fc=corlegenda))

    axes[2].annotate(r'c', xy=(0.05, 0.85), xycoords='axes fraction',
                        bbox=dict(boxstyle='circle', fc=corlegenda))

    axes[1].annotate(r'b', xy=(0.05, 0.85), xycoords='axes fraction',
                        bbox=dict(boxstyle='circle', fc=corlegenda))

    axes[3].annotate(r'd', xy=(0.05, 0.85), xycoords='axes fraction',
                        bbox=dict(boxstyle='circle', fc=corlegenda))
