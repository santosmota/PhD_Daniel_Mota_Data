...
app = Dash(__name__,
           ...
           external_stylesheets=[dbc.themes.CYBORG])  # dbc.themes.LUX   SANDSTONE
    ...
    dbc.Row([
        ...
        dbc.Col([
            daq.Gauge(
                ...
                scale={'start': 0, 'interval': 1, 'labelInterval': 1},
                label={'label': 'Wind Farm', 'style': {'font-size': gauge_label_font_size}},
                showCurrentValue=True,
                value=12,
                units='MW',
                max=14,
...
def update_output(case_value):
    ...
    if case_value == 'Case 2':
        # filename = DATA_PATH.joinpath('Case2.png')
        # filename = "https://github.com/santosmota/LowEmission2020Days/blob/main/figures/Case2.png"
        filename = r'data/Case2.png'

    elif case_value == 'Case 3':
        # filename = DATA_PATH.joinpath('Case3.png')
        filename = r'data/Case3.png'

    else:
        # filename = DATA_PATH.joinpath('Case1.png')
        filename = r'data/Case1.png'
...
if __name__ == '__main__':
   #  app.run_server(debug=True, port=9005)
