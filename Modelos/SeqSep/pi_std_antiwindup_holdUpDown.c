/*
 * File: pi_std_antiwindup_holdUpDown.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jan 31 22:30:45 2023
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME pi_std_antiwindup_holdUpDown
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  2 */
#define IN_PORT_2_NAME        cIblockUp
...
/* Input Port  4 */
#define IN_PORT_4_NAME        cIblockDown
...
extern void pi_std_antiwindup_holdUpDown_Outputs_wrapper(real_T *out,
			real_T *sOutAtMax,
			real_T *sOutAtMin,
			real_T *sIAtMax,
			real_T *sIAtMin,
...
extern void pi_std_antiwindup_holdUpDown_Update_wrapper(const real_T *error,
			const real_T *cPoff,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    pi_std_antiwindup_holdUpDown_Outputs_wrapper(out, sOutAtMax, sOutAtMin, sIAtMax, sIAtMin, Punlim, I, xD, Ts, p_width0, Kg, p_width1, Kp, p_width2, Ti, p_width3, outMax, p_width4, outMin, p_width5);
...
{
    const real_T *error = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *cPoff = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *cIblockUp = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *cIhold = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *cIblockDown = (real_T *) ssGetInputPortRealSignal(S, 4);
    const real_T *cIforce = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *Ivalue = (real_T *) ssGetInputPortRealSignal(S, 6);
    real_T *out = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *sOutAtMax = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *sOutAtMin = (real_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *sIAtMax = (real_T *) ssGetOutputPortRealSignal(S, 3);
    ...
    pi_std_antiwindup_holdUpDown_Update_wrapper(error, cPoff, cIblockUp, cIhold, cIblockDown, cIforce, Ivalue, out, sOutAtMax, sOutAtMin, sIAtMax, sIAtMin, Punlim, I, xD, Ts, p_width0, Kg, p_width1, Kp, p_width2, Ti, p_width3, outMax, p_width4, outMin, p_width5);
